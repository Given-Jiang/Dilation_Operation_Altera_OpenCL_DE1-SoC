...
(
   ...
   input logic clock2x,
   input logic resetn,
   // AVS avs_dilation_cra
   input logic avs_dilation_cra_read,
   input logic avs_dilation_cra_write,
   input logic [3:0] avs_dilation_cra_address,
   input logic [63:0] avs_dilation_cra_writedata,
   input logic [7:0] avs_dilation_cra_byteenable,
   output logic avs_dilation_cra_waitrequest,
   output logic [63:0] avs_dilation_cra_readdata,
   output logic avs_dilation_cra_readdatavalid,
   ...
   // INST dilation of dilation_top_wrapper
   dilation_top_wrapper dilation
   (
      .clock(clock),
      .clock2x(clock2x),
      .resetn(resetn),
      .cra_irq(kernel_irqs),
      // AVS avs_cra
      .avs_cra_read(avs_dilation_cra_read),
      .avs_cra_write(avs_dilation_cra_write),
      .avs_cra_address(avs_dilation_cra_address),
      .avs_cra_writedata(avs_dilation_cra_writedata),
      .avs_cra_byteenable(avs_dilation_cra_byteenable),
      .avs_cra_waitrequest(avs_dilation_cra_waitrequest),
      .avs_cra_readdata(avs_dilation_cra_readdata),
      .avs_cra_readdatavalid(avs_dilation_cra_readdatavalid),
...
(
   ...
   // INST kernel of dilation_function_wrapper
   dilation_function_wrapper kernel
   (
