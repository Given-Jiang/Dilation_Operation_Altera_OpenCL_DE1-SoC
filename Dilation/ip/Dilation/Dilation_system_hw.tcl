...
set_module_property NAME Dilation_system
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME Dilation_system
set_module_property TOP_LEVEL_HDL_FILE Dilation_system.v
set_module_property TOP_LEVEL_HDL_MODULE Dilation_system
...
### SLAVE interface avs_dilation_cra
add_interface avs_dilation_cra avalon end
set_interface_property avs_dilation_cra addressAlignment DYNAMIC
set_interface_property avs_dilation_cra burstOnBurstBoundariesOnly false
set_interface_property avs_dilation_cra explicitAddressSpan 0
set_interface_property avs_dilation_cra holdTime 0
set_interface_property avs_dilation_cra isMemoryDevice false
set_interface_property avs_dilation_cra isNonVolatileStorage false
set_interface_property avs_dilation_cra linewrapBursts false
set_interface_property avs_dilation_cra maximumPendingReadTransactions 1
set_interface_property avs_dilation_cra printableDevice false
set_interface_property avs_dilation_cra readLatency 0
set_interface_property avs_dilation_cra readWaitTime 1
set_interface_property avs_dilation_cra setupTime 0
set_interface_property avs_dilation_cra timingUnits Cycles
set_interface_property avs_dilation_cra writeWaitTime 0
set_interface_property avs_dilation_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_dilation_cra ENABLED true
add_interface_port avs_dilation_cra avs_dilation_cra_read read Input 1
add_interface_port avs_dilation_cra avs_dilation_cra_write write Input 1
add_interface_port avs_dilation_cra avs_dilation_cra_address address Input 4
add_interface_port avs_dilation_cra avs_dilation_cra_writedata writedata Input 64
add_interface_port avs_dilation_cra avs_dilation_cra_byteenable byteenable Input 8
add_interface_port avs_dilation_cra avs_dilation_cra_waitrequest waitrequest Output 1
add_interface_port avs_dilation_cra avs_dilation_cra_readdata readdata Output 64
add_interface_port avs_dilation_cra avs_dilation_cra_readdatavalid readdatavalid Output 1
...
add_file Dilation.v {SYNTHESIS SIMULATION}
